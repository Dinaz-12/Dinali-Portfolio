...
const categories: Category[] = [
  {
    ...
    skills: ["MySQL", "MS SQL Server","DuckDB", "Oracle", "MongoDB", "PostgreSQL", "Data Modeling", "Stored Procedures", "Indexing & Tuning","SQLite"],
  },
  {
    title: "Data Engineering",
    icon: Workflow,
    blurb: "Building reliable pipelines and warehouses for analytics-ready data.",
    skills: ["SSIS (ETL)", "SSAS (OLAP)", "DuckDB","ETL Development","Data Warehousing", "Star Schema", "Power Query", "Data Cleaning","Data Pipelines", "OLAP", "Airflow Basics", "API Integration"],
  },
  {
    title: "AI / ML",
    icon: Brain,
    blurb: "Predictive modeling, NLP, and intelligent assistants.",
    skills: ["Python", "Pandas", "NumPy", "scikit-learn", "Machine Learning", "Gemini API","NLP","Prompt Engineering", "EDA", "Feature Engineering"],
  },
  {
    ...
    skills: ["Power BI", "SQL", "Python", "Data Visualization", "KPI Reporting", "Business Intelligence", "Statistical Analysis","R","Tableau", "Excel (Advanced)", "Matplotlib", "Seaborn", "Streamlit", "Jupyter","Dashboard Design", "Data-Driven Decision Making"],
  },
  {
    title: "Software Engineering",
    icon: Code2,
    blurb: "Full-stack development with clean, maintainable architectures.",
    skills: ["React","JavaScript","MERN Stack", "TypeScript", "Node.js", "Express", "Flask", "Java", "Spring Boot", "REST APIs", "Git & GitHub"],
  },
  {
    title: "Cloud & Tools",
    icon: Cloud,
